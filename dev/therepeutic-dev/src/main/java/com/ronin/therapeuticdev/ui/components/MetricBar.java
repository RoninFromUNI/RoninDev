...
public class MetricBar extends JBPanel<MetricBar> {
    ...
    // icon = emoji/char, name = metric name, weight = percentage string like "30%"
    ...
    // takes 0.0 to 1.0, converts to percentage for the bar and label
    ...
    // rounded corners on the progress fill so it doesn't look like a windows 95 widget
